...
public class DemoApplication {
	...
	public Response webhook(@RequestBody String data) {
		...
		switch(action) {
			case "orderPizza":
				response = addNewOrder(db, parameters);
				break;
	...
	public Response addNewOrder(MongoDatabase db, JSONObject parameters) {
		// Retrieve data
	...
	public MongoClient getDatabaseConnection() {
		MongoClientURI uri = new MongoClientURI("mongodb://user:user@pizzashop-db-shard-00-00-g0r5a.mongodb.net:27017,pizzashop-db-shard-00-01-g0r5a.mongodb.net:27017,pizzashop-db-shard-00-02-g0r5a.mongodb.net:27017/test?ssl=true&replicaSet=PizzaSHop-DB-shard-0&authSource=admin");
